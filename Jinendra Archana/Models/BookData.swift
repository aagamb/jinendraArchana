...
let sections: [String: [Book]] = [
    ...
    "Poojan": [
       ...
       Book(name: "Dev Shastra Guru Poojan", hindiName: "देव-शास्त्र-गुरु पूजन", author: "पं. द्यानतरायजी", pgNum: 79),
       ...
       Book(name: "Panch Parmeshthi Poojan", hindiName: "पंच परमेष्ठी पूजन", author: "श्री राजमलजी पवैया", pgNum: 97),
       ...
       Book(name: "Videh Kshetra Stit Vidyaman 20 Tirthankar", hindiName: "विदेशक्षेत्र स्थित विद्धमान बीस तीर्थंकर पूजन", author: "पं. द्यानतरायजी", pgNum: 113),
       Book(name: "Chaubis Tirthankar Poojan (24 Tirthankar)", hindiName: "चौबीस तीर्थंकर पूजन", author: "डॉ. हुकमचंद भारिल्ल", pgNum: 116),
       Book(name: "Vartaman Chaubisi Poojan", hindiName: "श्री वर्तमान चौबीसी पूजन", author: "कविवर वृष्टिदासदासजी", pgNum: 121),
       Book(name: "Seemandhar Poojan", hindiName: "सीमंधर पूजन", author: "डॉ. हुकमचंद भारिल्ल", pgNum: 124),
       Book(name: "Dashlakshan Poojan", hindiName: "दशलक्षण धर्म पूजन", author: "पं. द्यानतरायजी", pgNum: 129),
       Book(name: "Samyak Ratnattray Poojan", hindiName: "सम्यक रत्नत्रय पूजन", author: "पं. द्यानतरायजी", pgNum: 132),
       Book(name: "Solahkaran Poojan", hindiName: "सोलहकारण पूजन", author: "पं. द्यानतरायजी", pgNum: 142),
       Book(name: "Panchmeru Poojan", hindiName: "पंचमेरु पूजन", author: "पं. द्यानतरायजी", pgNum: 145),
        Book(name: "Nandishwardweep Poojan", hindiName: "नन्दीश्वरद्वीप पूजन", author: "पं. द्यानतरायजी", pgNum: 148),
            Book(name: "Adinath Jinpoojan", hindiName: "श्री आदिनाथ जिनपूजन", author: "पं. जिनेन्द्रदासजी", pgNum: 152),
            Book(name: "Adinath Jinpoojan 2", hindiName: "श्री आदिनाथ जिनपूजन", author: "डॉ. अखिल बंसल", pgNum: 156),
            Book(name: "Chandraprabh Poojan", hindiName: "श्री चन्द्रप्रभ जिनपूजन", author: "पं. वृन्दावनदासजी", pgNum: 159),
        Book(name: "Chaitanya Vandana", hindiName: "चैतन्य वंदना", author: "पं. अभयकुमारजी", pgNum: 163),
            Book(name: "Shantinath Jinpoojan", hindiName: "श्री शांतिनाथ जिनपूजन", author: "पं. वृन्दावनदासजी", pgNum: 164),
            Book(name: "Shantinath Poojan", hindiName: "श्री शांतिनाथ पूजन", author: "डॉ. अखिल बंसल", pgNum: 168),
            Book(name: "Parshvanath Jinpoojan", hindiName: "श्री पार्श्वनाथ जिनपूजन", author: "पं. बद्रीप्रसादजी", pgNum: 172),
            Book(name: "Parshvanath Jinpoojan 2", hindiName: "श्री पार्श्वनाथ जिनपूजन", author: "डॉ. अखिल बंसल", pgNum: 177),
            Book(name: "Vardhaman Jinpoojan", hindiName: "श्री वर्धमान जिनपूजन", author: "पं. वृन्दावनदासजी", pgNum: 181),
            Book(name: "Mahavir Poojan", hindiName: "श्री महावीर पूजन", author: "डॉ. हुकमचंद भारिल्ल", pgNum: 185),
            Book(name: "Mahavir Poojan 2", hindiName: "श्री महावीर पूजन", author: "डॉ. अखिल बंसल", pgNum: 189),
            ...
            Book(name: "Bahubali Poojan", hindiName: "श्री बाहुबली पूजन", author: "श्री राजमल पवैया", pgNum: 201),
            Book(name: "Saptarshi Poojan", hindiName: "श्री सप्तर्षि पूजन", author: "पं. रंगलालजी", pgNum: 205),
            Book(name: "Saraswati Poojan", hindiName: "सरस्वती पूजन", author: "पं. द्यानतरायजी", pgNum: 208),
            Book(name: "Akshay Tritiya Poojan", hindiName: "अक्षय तृतीया पर्व पूजन", author: "श्री राजमलजी पवैया", pgNum: 211),
            Book(name: "Rakshabandhan Parva Poojan", hindiName: "रक्षाबंधन पर्व पूजन", author: "श्री राजमलजी पवैया", pgNum: 215),
            Book(name: "Veerashasan Jayanti Parva Poojan", hindiName: "वीराशासन जयंती पर्व पूजन", author: "श्री राजमलजी पवैया", pgNum: 220),
            Book(name: "Kshamavani Poojan", hindiName: "क्षमावाणी पूजन", author: "श्री राजमलजी पवैया", pgNum: 224),
            Book(name: "Deepmala Parva Poojan", hindiName: "दीपमालिका पर्व पूजन", author: "श्री राजमलजी पवैया", pgNum: 230),
            Book(name: "Shrut Panchami Parva Poojan", hindiName: "श्रुतपंचमी पर्व पूजन", author: "श्री राजमलजी पवैया", pgNum: 235),
            Book(name: "Nirvana Kshetra Poojan", hindiName: "निर्वाणक्षेत्र पूजन", author: "पं. घनतरायजी", pgNum: 239),
            ...
            Book(name: "Arghyavali", hindiName: "आचार्यावली", author: "-", pgNum: 246),
            Book(name: "Chaubis Tirthankar Arghya", hindiName: "चौबीस तीर्थंकरों के अर्घ्य", author: "-", pgNum: 246),
            Book(name: "Krutrim Chaityalayo Arghya", hindiName: "कृत्रिम व अकृत्रिम चैत्यालयों के अर्घ", author: "-", pgNum: 252),
            Book(name: "Mahaarghya (New)", hindiName: "महाअर्घ्य (नया)", author: "-", pgNum: 259),
            Book(name: "Mahaarghya (Old)", hindiName: "महाअर्घ्य (पूराना)", author: "-", pgNum: 260),
    ...
    "Adhyatmik Path": [
        Book(name: "Neerav Nirjhar (Samayik Path)", hindiName: "नीरव निर्झर (समायिक पाठ)", author: "श्री युगलजी", pgNum: 268),
        ...
        Book(name: "Vairagya Bhavna (Vajranabh Chakravarti)", hindiName: "वैराग्य भावना", author: "पं. भूधरदासजी", pgNum: 277),
        Book(name: "Chhahdhala", hindiName: "छहढाला", author: "पं. दौलतरामजी", pgNum: 280),
        Book(name: "Bhaktamar Stotra", hindiName: "भक्तामर-स्तोत्र (संस्कृत)", author: "आचार्य मानतुंग", pgNum: 292),
        Book(name: "Bhaktamar Stotra (Hindi)", hindiName: "भक्तामर-स्तोत्र (हिन्दी)", author: "पं. हेमराजजी", pgNum: 299),
        ...
        Book(name: "Mangalashtak", hindiName: "मंगलाष्टक", author: "-", pgNum: 317),
        Book(name: "Samadhimaran (Hindi)", hindiName: "समाधिमरण (हिन्दी)", author: "पं. सूरचन्दजी", pgNum: 319),
        Book(name: "Barah Bhavna", hindiName: "बारह भावना", author: "पं. जयचन्दजी छाबड़ा", pgNum: 328),
        Book(name: "Barah Bhavna 2", hindiName: "बारह भावना", author: "पं. भूधरदासजी", pgNum: 329),
    ...
    "Bhakti": [
        ...
        Book(name: "Hamko Bhi Bulvalo Bhagvan", hindiName: "हमको भी बुलवालो भगवन...", author: "-", pgNum: 341),
        ...
        Book(name:"Dhanya Dhanya Veetrag Vani", hindiName:"धन्य-धन्य वीतराग वाणी...", author:"-", pgNum:352),
        ...
        Book(name:"Jindesh Gyata", hindiName:"जिनदेश ज्ञाता जिनेन्द्र विख्याता...", author:"नन्दलालजी", pgNum:353),
        Book(name:"Bhraat Jinvaani Sam Nahi Aan", hindiName:"भ्रात जिनवाणी-सम नहीं आन...", author:"नन्दलालजी", pgNum:353),
        Book(name:"Aise Sadhu Suguru Kab Mili Hai", hindiName:"ऐसे साधु सुगुरु कब मिलि हैं...", author:"पं. भागचन्दजी", pgNum:354),
        Book(name:"Dhan Dhan Jaini Sadhu Jagat", hindiName:"धन-धन जैनी साधु जगत के...", author:"पं. भागचन्दजी", pgNum:354),
        Book(name:"Param Guru Barsat Gyaan Jhari", hindiName:"परम गुरु बरसत ज्ञान झरी...", author:"पं. घ्यानतरायजी", pgNum:354),
        Book(name:"Ve Munivar Kab Mili Hai", hindiName:"वे मुनिवर कब मिले हैं...", author:"पं. भूधरदासजी", pgNum:355),
        Book(name:"Aise Munivar Dekhe Van Mein", hindiName:"ऐसे मुनिवर देखे वन में...", author:"-", pgNum:355),
        Book(name:"Param Digambar Munivar Dekhe", hindiName:"परम दिगम्बर मुनिवर देखे...", author:"-", pgNum:355),
        ...
        Book(name:"Mein Param Digambar Sadhu Ke", hindiName:"मैं परम दिगम्बर साधु के...", author:"सौभाग्यमलजी", pgNum:358),

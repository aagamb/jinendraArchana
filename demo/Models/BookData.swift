...
let sections: [String: [Book]] = [
    "Stavan": [
        ...
        Book(name: "Darshan Stuti", hindiName: "दर्शन स्तुति (सकलराश...)", author: "पं. दौलतरामजी", pgNum: 54),
        Book(name: "Darshan Path", hindiName: "दर्शन पाठ (दर्शन श्री देवाधिदेव का...)", author: "श्री युगलजी", pgNum: 56),
    ...
    "Poojan": [
       ...
       Book(name: "Vinay Path", hindiName: "विनय पाठ", author: "-", pgNum: 69),
       ...
       Book(name: "Dev-Shastra-Guru Poojan", hindiName: "देव-शास्त्र-गुरु पूजन", author: "श्री युगलजी", pgNum: 83),
       Book(name: "Dev-Shastra-Guru Poojan", hindiName: "देव-शास्त्र-गुरु पूजन", author: "डॉ. हुकमचंद भारिल्ल", pgNum: 87),
       Book(name: "Dev-Shastra-Guru Poojan", hindiName: "देव-शास्त्र-गुरु पूजन", author: "डॉ. अखिल बंसल", pgNum: 91),
       ...
       Book(name: "Siddha Poojan", hindiName: "सिद्धपूजन", author: "डॉ. हुकमचंद भारिल्ल", pgNum: 105),
       Book(name: "Siddha Poojan", hindiName: "सिद्धपूजन", author: "श्री युगलजी", pgNum: 109),
       ...
       Book(name: "Panchme Poojan", hindiName: "पंचमे पूजन", author: "पंडित घनतरायजी", pgNum: 135),
        Book(name: "Nandishwardweep Poojan", hindiName: "नन्दीश्वरद्वीप पूजन", author: "पंडित घनतरायजी", pgNum: 148),
            Book(name: "Shri Adinath Jinpoojan", hindiName: "श्री आदिनाथ जिनपूजन", author: "पंडित जिनेन्द्रदासजी", pgNum: 152),
            Book(name: "Shri Adinath Jinpoojan", hindiName: "श्री आदिनाथ जिनपूजन", author: "डॉ. अखिल बंसल", pgNum: 156),
            Book(name: "Shri Chandraprabha Jinpoojan", hindiName: "श्री चन्द्रप्रभ जिनपूजन", author: "पंडित वृन्दावनदासजी", pgNum: 159),
            Book(name: "Chaitanya Vandana", hindiName: "चैतन्य वंदना", author: "पं. अभयकुमारजी", pgNum: 163),
            Book(name: "Shri Shantinath Jinpoojan", hindiName: "श्री शांतिनाथ जिनपूजन", author: "पंडित वृन्दावनदासजी", pgNum: 164),
            Book(name: "Shri Shantinath Poojan", hindiName: "श्री शांतिनाथ पूजन", author: "डॉ. अखिल बंसल", pgNum: 168),
            Book(name: "Shri Parshvanath Jinpoojan", hindiName: "श्री पार्श्वनाथ जिनपूजन", author: "पंडित बद्रीप्रसादजी", pgNum: 172),
            Book(name: "Shri Parshvanath Jinpoojan", hindiName: "श्री पार्श्वनाथ जिनपूजन", author: "डॉ. अखिल बंसल", pgNum: 177),
            Book(name: "Shri Vardhaman Jinpoojan", hindiName: "श्री वर्धमान जिनपूजन", author: "पंडित वृन्दावनदासजी", pgNum: 181),
            Book(name: "Shri Mahavir Poojan", hindiName: "श्री महावीर पूजन", author: "डॉ. हुकमचंद भारिल्ल", pgNum: 185),
            Book(name: "Shri Mahavir Poojan", hindiName: "श्री महावीर पूजन", author: "डॉ. अखिल बंसल", pgNum: 189),
            Book(name: "Shri Panch Balayati Jinpoojan", hindiName: "श्री पंच बालायति जिनपूजन", author: "पं. अभयकुमारजी", pgNum: 192),
            Book(name: "Shri Bharat-Bahubali Poojan", hindiName: "श्री भरत-बाहुबली पूजन", author: "डॉ. हुकमचंद भारिल्ल", pgNum: 196),
            Book(name: "Shri Bahubali Poojan", hindiName: "श्री बाहुबली पूजन", author: "श्री राजमल पचेया", pgNum: 201),
            Book(name: "Shri Samkranti Poojan", hindiName: "श्री संक्रांति पूजन", author: "पंडित रंगलालजी", pgNum: 205),
